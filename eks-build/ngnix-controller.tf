...
#Local Cirtificate Authority    
    service.beta.kubernetes.io/aws-load-balancer-ssl-cert: ${aws_acm_certificate.nginx.arn}
...
resource "local_file" "nginxcntrlr" {
    content     = local.nginxcontroller
    filename = "output/nginx-controller.yaml"
}
